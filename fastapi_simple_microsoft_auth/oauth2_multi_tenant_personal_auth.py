...
class OAuth2MultiTenantPersonalAuth(Oauth2AuthBase):
    """Implement Microsoft Authentication for Multi-Tenant Applications using personal accounts.
